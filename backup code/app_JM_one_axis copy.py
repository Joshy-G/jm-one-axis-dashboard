...
def load_and_process_trade_data():
    ...
    raw_df["Equity"] = STARTING_CAPITAL + raw_df["P&L"].cumsum()
...
if menu == "Trade Entry":
    ...
    if st.button("Submit Trade") and not st.session_state.trade_submitted:
        ...
        MAX_RISK_PER_TRADE = STARTING_CAPITAL * 0.01
...
# -------------------- Performance Dashboard --------------------
    ...
    if df.empty:
        ...
        if period_df.empty:
            ...
            period_df["Equity_Period"] = STARTING_CAPITAL + period_df["P&L"].cumsum()
...
# -------------------- Risk Monitoring --------------------
    ...
    if df.empty:
        ...
        MAX_DAILY_LOSS = STARTING_CAPITAL * 0.02
        MAX_DRAWDOWN = STARTING_CAPITAL * 0.10
        MAX_RISK_PER_TRADE = STARTING_CAPITAL * 0.01
